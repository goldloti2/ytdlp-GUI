...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.vid_none_rad, 1, 3, 1, 1)
        self.label_2 = QtWidgets.QLabel(self.horizontalGroupBox_2)
        self.label_2.setAlignment(QtCore.Qt.AlignCenter)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 1, 0, 1, 1)
        self.vid_worst_rad = QtWidgets.QRadioButton(self.horizontalGroupBox_2)
        self.vid_worst_rad.setObjectName("vid_worst_rad")
        self.vid_btn_grp.addButton(self.vid_worst_rad)
        self.gridLayout.addWidget(self.vid_worst_rad, 1, 2, 1, 1)
        ...
        self.aud_worst_rad = QtWidgets.QRadioButton(self.horizontalGroupBox_2)
        self.aud_worst_rad.setObjectName("aud_worst_rad")
        self.aud_btn_grp.addButton(self.aud_worst_rad)
        self.gridLayout.addWidget(self.aud_worst_rad, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.aud_none_rad, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.aud_custom_rad, 2, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.vid_custom_rad, 1, 4, 1, 1)
        ...
        self.cookie_check = QtWidgets.QCheckBox(self.horizontalGroupBox_2)
        self.cookie_check.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.cookie_check.setObjectName("cookie_check")
        self.gridLayout.addWidget(self.cookie_check, 3, 0, 1, 1)
        self.cookie_file_btn = QtWidgets.QToolButton(self.horizontalGroupBox_2)
        self.cookie_file_btn.setCheckable(False)
        self.cookie_file_btn.setObjectName("cookie_file_btn")
        self.gridLayout.addWidget(self.cookie_file_btn, 3, 5, 1, 1)
        self.cookie_file = QtWidgets.QLineEdit(self.horizontalGroupBox_2)
        self.cookie_file.setReadOnly(False)
        self.cookie_file.setClearButtonEnabled(False)
        self.cookie_file.setObjectName("cookie_file")
        self.gridLayout.addWidget(self.cookie_file, 3, 1, 1, 4)
        ...
        self.gridLayout.addWidget(self.save_def_btn, 4, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.vid_worst_rad.setText(_translate("MainWindow", "Worst"))
        self.aud_best_rad.setText(_translate("MainWindow", "Best"))
        self.aud_worst_rad.setText(_translate("MainWindow", "Worst"))
        self.aud_none_rad.setText(_translate("MainWindow", "None"))
        self.aud_custom_rad.setText(_translate("MainWindow", "RadioButton"))
        self.save_dir_btn.setText(_translate("MainWindow", "..."))
        self.vid_best_rad.setText(_translate("MainWindow", "Best"))
        self.vid_custom_rad.setText(_translate("MainWindow", "RadioButton"))
        self.label.setText(_translate("MainWindow", "Save Folder :"))
        self.label_3.setText(_translate("MainWindow", "Audio Option :"))
        self.cookie_check.setText(_translate("MainWindow", "Cookie :"))
        self.cookie_file_btn.setText(_translate("MainWindow", "..."))
