...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.format_table.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.format_table.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.format_table.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.format_table.setTabKeyNavigation(False)
        self.format_table.setAlternatingRowColors(False)
        self.format_table.setSelectionMode(QtWidgets.QAbstractItemView.NoSelection)
        self.format_table.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.format_table.setRowCount(0)
        self.format_table.setObjectName("format_table")
        self.format_table.setColumnCount(10)
        item = QtWidgets.QTableWidgetItem()
        self.format_table.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.format_table.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.format_table.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.format_table.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.format_table.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.format_table.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.format_table.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.format_table.setHorizontalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        self.format_table.setHorizontalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        self.format_table.setHorizontalHeaderItem(9, item)
        self.format_table.horizontalHeader().setVisible(True)
        self.format_table.horizontalHeader().setCascadingSectionResizes(False)
        self.format_table.horizontalHeader().setDefaultSectionSize(30)
        self.format_table.horizontalHeader().setHighlightSections(True)
        self.format_table.horizontalHeader().setStretchLastSection(True)
        self.format_table.verticalHeader().setVisible(False)
        self.format_table.verticalHeader().setSortIndicatorShown(False)
        self.format_table.verticalHeader().setStretchLastSection(False)
        ...
        self.ret_def_btn.setAutoDefault(True)
        ...
        self.save_def_btn.setAutoDefault(True)
        ...
        self.dl_btn.setAutoDefault(True)
        ...
        MainWindow.setTabOrder(self.url_line, self.search_btn)
        MainWindow.setTabOrder(self.search_btn, self.res_list)
        MainWindow.setTabOrder(self.res_list, self.dl_btn)
        MainWindow.setTabOrder(self.dl_btn, self.format_table)
        MainWindow.setTabOrder(self.format_table, self.save_dir_line)
        MainWindow.setTabOrder(self.save_dir_line, self.save_dir_btn)
        MainWindow.setTabOrder(self.save_dir_btn, self.vid_best_rad)
        MainWindow.setTabOrder(self.vid_best_rad, self.vid_none_rad)
        MainWindow.setTabOrder(self.vid_none_rad, self.vid_custom_rad)
        MainWindow.setTabOrder(self.vid_custom_rad, self.vid_custom_line)
        MainWindow.setTabOrder(self.vid_custom_line, self.aud_best_rad)
        MainWindow.setTabOrder(self.aud_best_rad, self.aud_none_rad)
        MainWindow.setTabOrder(self.aud_none_rad, self.aud_custom_rad)
        MainWindow.setTabOrder(self.aud_custom_rad, self.aud_custom_line)
        MainWindow.setTabOrder(self.aud_custom_line, self.ck_check)
        MainWindow.setTabOrder(self.ck_check, self.ck_file_line)
        MainWindow.setTabOrder(self.ck_file_line, self.ck_file_btn)
        MainWindow.setTabOrder(self.ck_file_btn, self.ret_def_btn)
        MainWindow.setTabOrder(self.ret_def_btn, self.save_def_btn)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.format_table.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "id"))
        item = self.format_table.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "ext"))
        item = self.format_table.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "res"))
        item = self.format_table.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "fps"))
        item = self.format_table.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "ch"))
        item = self.format_table.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "size"))
        item = self.format_table.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "vbr"))
        item = self.format_table.horizontalHeaderItem(7)
        item.setText(_translate("MainWindow", "abr"))
        item = self.format_table.horizontalHeaderItem(8)
        item.setText(_translate("MainWindow", "asr"))
        item = self.format_table.horizontalHeaderItem(9)
